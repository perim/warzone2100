...
static RETICULE_TYPE reticuleType = RET_STANDARD;
...
void intResetScreen(bool NoAnim)
{
	...
	if (ReticuleUp && reticuleType == RET_STANDARD)
	{
	...
	else if (ReticuleUp && reticuleType == RET_DROID)
	{
// TODO
	}
	else if (ReticuleUp && reticuleType == RET_STRUCTURE)
	{
// TODO
	}
...
bool intAddReticule(RETICULE_TYPE ret)
{
	if (ReticuleUp && ret == reticuleType)
	{
