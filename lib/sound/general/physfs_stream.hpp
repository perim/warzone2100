...
#ifndef __PHYSFS_STREAM_HPP__
#define __PHYSFS_STREAM_HPP__
    ...
    class physfs_filebuf : public std::basic_streambuf<_CharT, _Traits>
    {
        ...
        protected:
            ...
            virtual int_type underflow()
            {
                ...
                PHYSFS_sint64 objectsRead = PHYSFS_read(_file, &*_buf.begin(), sizeof(char_type), _buf.size());
                ...
                char_type* xend = (static_cast<size_t> (objectsRead) == _buf.size()) ? &*_buf.end() : &_buf[objectsRead];
            ...
            virtual int_type overflow(int_type c = traits_type::eof())
            {
                ...
                char_type* xend = (static_cast<size_t> (res) == _buf.size()) ? &*_buf.end() : &_buf[res];
        ...
        private:
            PHYSFS_file* _file;
            bool _writeStream;
            boost::array<char_type, 1024> _buf;
    };
