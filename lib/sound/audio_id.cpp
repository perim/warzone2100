 ...
 * audio_id.cpp
 *
 * Matches audio filenames to audio id enums
 */
/***************************************************************************/
...
struct AUDIO_ID_MAP
{
    const INGAME_AUDIO    ID;
    const std::string     fileName;

    inline const std::string& key() const { return fileName; }
    inline const INGAME_AUDIO& value() const { return ID; }
};

/***************************************************************************/

static const boost::array<AUDIO_ID_MAP, ID_MAX_SOUND> asAudioID =
{{
