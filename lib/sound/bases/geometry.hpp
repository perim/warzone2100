...
#ifndef LIB_GEOMETRY_VERTEX_HPP
#define LIB_GEOMETRY_VERTEX_HPP
...
class Geometry
{
    public:
        ...
        virtual void getRotation(float& pitch, float& yaw, float& roll) = 0;
        virtual void getRotation(int& pitch, int& yaw, int& roll) = 0;
        ...
        virtual void getVelocity(int& x, int& y, int& z) = 0;
};

#endif // LIB_GEOMETRY_VERTEX_HPP
